...
static bool try_flush_buffer(Conn *conn) {
    ...
    // still got some data in wbuf, try to write again
    return true;
}
...
static bool try_one_request(Conn *conn) {
    ...
    // TODO: frequent memmove is inefficient, should find better ways
